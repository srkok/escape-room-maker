...
3. (advanced)自由な問題設定で, 脱出室空間を開発してください.
   - 特に思いつかない場合, 以下を開発するにはどうすればよいか考えてみてください.
     - 何もクリックしなければ素直に脱出可能だが, 1 度でもクリックしてしまうと脱出不可能となる空間.
     - 普通の迷路内に, 1 度でもクリックしてしまうと脱出不可能となるお邪魔オブジェクトがある空間.
     - オブジェクトとその対象が複雑に絡み合っており, 試行錯誤を繰り返して脱出する空間.
     - 大きな空間が右と左にあり, 共によく似ているが少し違う 2 つの空間を, 全く同じにすると脱出できる空間.
